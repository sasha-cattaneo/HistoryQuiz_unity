...
Per lo sviluppo di \textcolor{red}{NOME} questi requisiti, divisi tra funzionali e non funzionali, sono stati raccolti nel documento \textit{Software Requirements and Design}.
...
\begin{tabular}{|l|p{10cm}|}
    ...
    \textbf{Usabilità}                                                                  & L'interfaccia utente deve essere intuitiva. Il tempo di apprendimento per un nuovo utente deve essere inferiore ai 5 minuti. \\ \hline
    \textbf{Performance}                                                                & Il gioco deve essere responsivo, dall’azione dell’utente alla risposta deve passare meno di 1 secondo. \\ \hline
    \begin{tabular}[c]{@{}l@{}}\textbf{Portabilità}\\ \textbf{dei dati} \end{tabular}   & I dati devono essere serializzati in formato \textbf{JSON}, per essere leggibili e modificabili esternamente. \\ \hline
    \begin{tabular}[c]{@{}l@{}}\textbf{Portabilità}\\ \textbf{del gioco} \end{tabular}  & Il gioco deve essere compatibili su diverse piattaforme, tra cui Windows, macOS e Linux. \\ \hline
