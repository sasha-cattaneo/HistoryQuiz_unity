...
\begin{table}[H]
    ...
    \begin{tabular}[c]{@{}l@{}}Ritardi di \\ sviluppo\end{tabular}                & \begin{tabular}[c]{@{}l@{}}Ritardi di sviluppo\\ rispetto al\\ piano scelto\end{tabular}                    & Media                & Media                 & \begin{tabular}[c]{@{}l@{}}Definizione di\\ obiettivi\\ intermedi\\ raggiungibili\end{tabular}              \\
                                                                                  &                                                                                                             & \multicolumn{1}{l}{} & \multicolumn{1}{l}{}  &                                                                                                           \\
    \begin{tabular}[c]{@{}l@{}}Corruzione\\dei dati di\\ salvataggio\end{tabular} & \begin{tabular}[c]{@{}l@{}}Perdita di dati\\ a causa di\\un problema\end{tabular}                           & Bassa                & Bassa                 & \begin{tabular}[c]{@{}l@{}}Implementare\\backup\\automatici\end{tabular}                                  \\
                                                                                  &                                                                                                             & \multicolumn{1}{l}{} & \multicolumn{1}{l}{}  &                                                                                                           \\
    \begin{tabular}[c]{@{}l@{}}Bug nel\\codice\end{tabular}                       & \begin{tabular}[c]{@{}l@{}}Presenza di bug\\nella logica\\del gioco\end{tabular}                            & Alta                 & Alta                  & \begin{tabular}[c]{@{}l@{}}Implementare\\ test esaustivi\\ durante l’intero\\ sviluppo\end{tabular}       \\ \bottomrule
    \end{tabular}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=15cm]{images/class_diagram1.drawio.png}
