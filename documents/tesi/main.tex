...
\title{Quiz me! - Progettazione e sviluppo di un quiz interattivo come strumento educativo}
\subtitle{}
\advisor{Prof.ssa Bonfanti Silvia}
\coadvisor{Prof. Gargantini Angelo Michele}
